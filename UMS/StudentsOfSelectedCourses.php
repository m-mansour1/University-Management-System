        ...
        <div class="container my-5">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $st_id = $_SESSION['faculty_id'];
                    $sql = "SELECT student FROM `course_registrations` WHERE course='$course_name'";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                            ...
                            <td>
                                ...
                                <a class='btn btn-primary btn-sm' href='/UMS/FacultyUploadGrade.php?course_id=$course_id&student_id=$Allstudents[id]'>Upload Grade</a>
                            </td>
                        </tr>";
                    }
                    ?>
