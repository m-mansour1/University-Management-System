...
if (!$row) {
    header("location:/UMS/AdminMyProfile.php");
    exit;
}
$name = $row["name"];
...
$semester =  $row["activity_semester"];
$campus= $row["campus"];
if (isset($_POST['submit'])) {
    ...
    do {
        ...
        `activity_semester`='$semester',`campus`='$campus',`DateOfBirth`='$dob',
        `Address`='$address ',`PhoneNumber`='$phone',`email`='$email',
        `password`='$password',`user_type`='$user_type' WHERE id='$st_id'";
        $result = mysqli_query($conn, $sql);
        if (!$result) {
        ...
        <div class="container my-5">
            ...
            <form method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="campus" value="<?php echo $campus; ?>">
                    </div>
                </div>
                <br>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-3 d-grid">
                        <a class="btn btn-outline-primary" href="/UMS/AdminMyProfile.php" role="button">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
