    ...
    <div class="home_content">
        <div class="text">
            <div class="content" id="dashboard">
                ...
                <h3>welcome <span><?php echo $_SESSION['admin_name'] ?></h3>
            </div>
            <center>
                <div class="parent">
                    <div class="child">
                        <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="Faculty.php" class="btn btn-success">Check Instructors</a>
                            </div>
                        </div>
                    </div>
                    <div class="child">
                        <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="admin.php" class="btn btn-danger">Check Admins</a>
                            </div>
                        </div>
                    </div>
                    <div class="child">
                        <div class="card text-white bg-warning mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="course.php" class="btn btn-warning">Check Courses</a>
                            </div>
                        </div>
                    </div>
                    <div class="child">
                        <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="AdminStudents.php" class="btn btn-primary">Check Students</a>
                            </div>
                        </div>
                    </div>
                </div>
