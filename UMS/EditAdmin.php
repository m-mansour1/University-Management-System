...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        $successMessage = "Admin was Modified successfully";
    } while (false);
}
?>
        ...
        <div class="container my-5">
            ...
            <form method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="AdminName" value="<?php echo $name; ?>">
                    </div>
                </div>
                <br>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="AdminUsername" value="<?php echo $username; ?>">
                    </div>
                </div>
                <br>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="AdminEmail" value="<?php echo $Email; ?>">
                    </div>
                </div>
                <br>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <input type="password" class="form-control" name="AdminPassword" value="<?php echo $Password; ?>">
                    </div>
                </div>
                <br>
                <?php
