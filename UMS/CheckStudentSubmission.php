...
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    $sql =  "SELECT `file` FROM `submissions` WHERE course_id=$id";
    $res = $conn->query($sql);
...
<body>
    ...
    <div class="home_content">
        ...
        ?>
        <h2>Students' Submissions in <?php echo$Allcourses['name'] ?></h2>
        <div class="row">
            <?php
            $course_id = $_GET["id"];
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <?php }
                            ...
                            echo "<tr><td colspan=4>No assignments Submissions!</td></tr>";
                        } ?>
                    </tbody>
                </table>
            </div>
