...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $username = $_GET["FacultyUsername"];
    $semester = $_GET["semester"];
    $campus = $_GET["campus"];
    $DOB= $_GET["DOB"];
    $Address = $_GET["Address"];
    $Phone = $_GET["PhoneNumber"];
    $Email = $_GET["FacultyEmail"];
    ...
    do {
        if (
            ...
            || empty($Email) || empty($DOB) || empty($Password) || empty($Phone) &&($Password=="d41d8cd98f00b204e9800998ecf8427e"))
        ) {
        ...
        $successMessage = "Faculty was Modified successfully";
    } while (false);
}
?>
